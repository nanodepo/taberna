    ...
    <x-slot name="content">
        ...
        <x-ui::section class="mt-0 sm:mt-3">
            ...
            <x-ui::header
                ...
                subtitle="Online store where you can find your happiness"
                class="mt-12 mb-6"
            />

            <form class="relative w-full max-w-md mx-auto mb-12">
                <input
                    type="text"
                    name="search"
                    wire:model="search"
